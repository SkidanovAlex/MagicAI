...
AddRule(T_GET_EFFECT_INTERNAL, ["become", T_PLUS_X_PLUS_X, T_OBJECTS], None, Object(0))
AddRule(T_GET_EFFECT_INTERNAL, ["becomes", T_PLUS_X_PLUS_X, T_OBJECTS], None, Object(0))
