...
AddRule(T_ACTION_QUALIFIER_BEFORE, ["if", T_OBJECTS, W_IS, "monstrous", "COMMA"], None, Object(0))
AddRule(T_ACTION_QUALIFIER_BEFORE, ["if", T_OBJECTS, W_IS, "in", T_PART_OF_FIELD, "COMMA"], None, Object(0))
